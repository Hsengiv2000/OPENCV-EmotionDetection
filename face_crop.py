...
import cv2
import os
#debuuggis - escape cahracter \\ not /
...
directory = r"C:\Users\Venkatesh\Documents\python projects\emotionDetector\images\happy\\"

## directory where the images to be saved:
f_directory =r"C:\Users\Venkatesh\Documents\python projects\emotionDetector\newimages\happy\\"
...
def facecrop(image):
    ...
    try:
        ...
        for f in faces:
            ...
            cv2.imwrite(r"C:\\Users\\Venkatesh\\Documents\\python projects\\emotionDetector\\newimages\\happy\\" + f_name, sub_face)
            print ("Writing: " + f_directory + f_name)
